...
| td-073 | JOIN: list available rooms so joining needs no typing (Craig's workaround for the td-072 typing defect) | in_progress — Muse subagent assigned 2026-09-26 (signaling live; building room-list UI on JOIN; manual code entry stays as fallback) | Muse subagent | — | 2026-09-26 |
