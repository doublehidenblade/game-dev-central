...
| td-062 | Net crashes every frame after a rejected join (null _socket in _process) | merged 2026-09-26 (PR #101, 689751da); export/publish in flight — live verification pending | Muse subagent | — | 2026-09-26 |
...
| td-066 | Touch controls dead on mobile in multiplayer race (left/right tap does nothing) | PR #105 open draft (fix/td-066-mp-touch-controls): _prepare_base_map was deleting the TouchControls layer — now kept, hidden on results/host-left — merge/publish pending | Muse subagent | PR #105 | 2026-09-26 |
...
| td-068 | Deploy signaling server: "Enforce single instance" step fails, redeploys go out unhealthchecked (td-064 step; 2/2 runs fail) | open — watchdog-filed 2026-09-26, dispatch queued | — | — | 2026-09-26 |
