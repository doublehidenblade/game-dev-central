...
| td-069 | Multiplayer: each player picks their own car color (at least 4 colors) | in_review 2026-09-26 — PR #108 opened (not merged): 6-color picker on HOST/JOIN, signaling sync with server-side duplicate reassignment, lobby re-picker with taken disabled, body_tint shader; protocol tests pass (1/5 validation) | Muse subagent | PR #108 | 2026-09-26 |
| td-070 | iPhone Safari: tapping room-code field on JOIN never opens the keyboard | open | — | — | 2026-09-26 |
