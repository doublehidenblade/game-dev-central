...
| td-071 | Signaling server unreachable (Fly.io trial ended, org suspended ~16:52Z; deploy runs 36257155535 + 36258473500 failed) — create/join/WebSocket dead | blocked on Craig 2026-09-26: add credit card at https://fly.io/trial (login with Google); then rerun deploy-signaling.yml + verify /health + resume td-054 Phase 4 | Craig | — | 2026-09-26 |
| td-072 | Android Chrome: typing into DRIVER NAME / ROOM CODE still fails (native overlay didn't fix it; Craig 2026-09-26: "the typing still isnt resolved") | in_review — fix PR open (overlay never created: input.set() has no such method on JavaScriptObject; replaced with direct property access) | Muse subagent | [#110](https://github.com/doublehidenblade/tokyo-drift-3d/pull/110) | 2026-09-26 |
| td-073 | JOIN: list available rooms so joining needs no typing (Craig's workaround for the td-072 typing defect) | blocked — needs td-071 signaling live (room registry is server-side) | — | — | 2026-09-26 |
