...
| td-072 | Android Chrome: typing into DRIVER NAME / ROOM CODE still fails (native overlay never created — .get()/.set() on JavaScriptObject; Craig 2026-09-26: "the typing still isnt resolved") | in_review — fix MERGED (PR #110, 4110846b); awaiting publish + live verification | Muse subagent | PR #110 | 2026-09-26 |
