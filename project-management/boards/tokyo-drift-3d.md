...
| td-061 | Can't enter driver name on mobile (typing fails) — Godot LineEdit virtual keyboard unreliable on Android Chrome; fix via native HTML input overlay | in_review | Muse | PR #97 | 2026-09-26 |
