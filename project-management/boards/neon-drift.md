...
| p3d-083 (todo156) | todo156 | split/merge fork not readable in gameplay | in_review | Codex worker — [PR #68](https://github.com/doublehidenblade/neon-drift/pull/68), visual evidence complete; CPU gate blocked | 2026-09-26 |
